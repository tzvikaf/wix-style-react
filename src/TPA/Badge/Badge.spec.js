...
describe('Badge', () => {
    ...
    describe('should be able to apply all the css classes by user', () => {
        it('primary and alignment top', () => {
            ...
            const dataHook = 'badge-hook';
            const wrapper = div.appendChild(ReactTestUtils.renderIntoDocument(
                <div><Badge alignment="top" type="primary"
                    ...
                    dataHook={dataHook}>Hi</Badge></div>
            ));
            const badgeTestkit = badgeTestkitFactory({ wrapper, dataHook });
        ...
        it('warning and middle', () => {
            ...
            const dataHook = 'badge-hook';
            const wrapper = div.appendChild(ReactTestUtils.renderIntoDocument(
                <div><Badge alignment="middle" type="warning"
                    primaryClassName="primaryCustomClassName"
                    warningClassName="warningCustomClassName"
                    defaultClassName="defaultCustomClassName"
                    successClassName="successCustomClassName"
        ...
        it('info and bottom', () => {
            ...
            const dataHook = 'badge-hook';
            const wrapper = div.appendChild(ReactTestUtils.renderIntoDocument(
                <div><Badge alignment="bottom" type="info"
                    primaryClassName="primaryCustomClassName"
                    warningClassName="warningCustomClassName"
                    defaultClassName="defaultCustomClassName"
                    successClassName="successCustomClassName"
        ...
        it('danger and top', () => {
            ...
            const dataHook = 'badge-hook';
            const wrapper = div.appendChild(ReactTestUtils.renderIntoDocument(
                <div><Badge alignment="top" type="danger"
                    primaryClassName="primaryCustomClassName"
                    warningClassName="warningCustomClassName"
                    defaultClassName="defaultCustomClassName"
                    successClassName="successCustomClassName"
        ...
        it('success and top', () => {
            ...
            const dataHook = 'badge-hook';
            const wrapper = div.appendChild(ReactTestUtils.renderIntoDocument(
                <div><Badge alignment="top" type="success"
                    primaryClassName="primaryCustomClassName"
                    warningClassName="warningCustomClassName"
                    defaultClassName="defaultCustomClassName"
                    successClassName="successCustomClassName"
        ...
        it('should have defaults', () => {
            ...
            const dataHook = 'badge-hook';
            const wrapper = div.appendChild(ReactTestUtils.renderIntoDocument(
                <div><Badge alignmentMiddleClassName="alignmentMiddleCustomClassName" defaultClassName="defaultCustomClassName" dataHook={dataHook}>Hi</Badge></div>
            ));
            const badgeTestkit = badgeTestkitFactory({ wrapper, dataHook });
